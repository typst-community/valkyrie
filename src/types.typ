...
/// Specialization of that is only satisfied by whole numbers. Parameters of  remain available for further requirments.
#let integer = number.with( name: "integer", types: (int,))

/// Specialization of  that is only satisfied by floating point numbers. Parameters of  remain available for further requirments.
